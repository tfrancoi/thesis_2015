...
Maintenant que nous avons fait le tour du problème et que nous avons défini les objectifs, nous devons définir quel type de gestion des compétences sera le plus adapté pour les atteindre, puis définir une méthodologie et un plan d'action pour sa mise en place. Mais, avant tout, il faut s'accorder sur la définition de "compétence". 

\section{Définition de la compétence}
Regardons ce que la littérature dit à propos de la notion de compétence. Commençons parce ce qu'il en est dit dans le livre de Guérin, Cadin, Pigeyre\citep[pp.170-171]{gestionressourceshumaine2007}
\begin{quotation}
...
Nous pouvons observer un point de vue assez similaire dans Aubret, Gilbert\citep[pp.7]{evalcompetence} où là encore il ne s'accorde pas sur une définition unique de la compétence:
